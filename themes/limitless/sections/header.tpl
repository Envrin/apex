			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown">
					<a href="#" onclick="ajax_send('core/clear_dropdown', 'dropdown=alerts&auth_type=admin');" class="navbar-nav-link dropdown-toggle caret-0" data-toggle="dropdown">
						...
						<span id="badge_unread_alerts" style="display: ~display_badge_unread_alerts~" class="badge badge-pill bg-warning-400 ml-auto ml-md-0">~unread_alerts~</span>
					</a>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <e:page_title textonly="1"></h4>
					</div>
                </div>
            </div>
