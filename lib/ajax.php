...
/**
* Adds an entry to the self::$actions array.  Upon request 
* completion, this array is formatted into JSON, and returned to the browser 
* for processing via Javascript.
*
...
/**
* Deletes all rows within the <tbody> of specified table.
( Used for pagination, quick search, and sorting rows via AJAX.
*
...
/**
* Adds one or more rows to a table.  Used for a variety of 
* reasons including search, sort, and pagination.
* 
*     @param string $divid The element ID of the table.
...
/**
* Sets the pagination links of a data table component.  
* Used during pagination, search, and sort of a table.
* 
