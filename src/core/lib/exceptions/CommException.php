...
/**
* Handles all errors related to communications, such as 
* invalid e-mail address, unable to connect to SMTP, unable to 
* send SMS message via Nexcmo, etc.
*/
class CommException extends \apex\core\lib\exceptions\ApexException
{
    // Properties
