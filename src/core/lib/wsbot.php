...
use apex\core\lib\ajax;
use Ratchet\MessageComponentInterface;
use Ratchet\ConnectionInterface;

/**
* Handles the internet web socket server, and listens for 
* messages.  For more information, refer to the developer documenation.
*/
class wsbot implements MessageComponentInterface
{
...
protected function authenticate(string $auth_string, ConnectionInterface $from)
{
    ...
    if ($vars = registry::$redis->hgetall($auth_hash)) { 
        $user['type'] = $vars['type'];
