...
public static function geoip(string $ipaddr = ''):array 
{
    ...
    // Load library file
    require_once(SITE_PATH . '/src/core/lib/third_party/maxmind/autoload.php');
    ...
    // Load reader
    $reader = new \MaxMind\Db\Reader(SITE_PATH . '/src/core/lib/third_party/maxmind/GeoLite2-City.mmdb');
